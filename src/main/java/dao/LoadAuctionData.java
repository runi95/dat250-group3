...
public class LoadAuctionData {
	...
	private User createUser(String name, String lastName, String userName, String pwd, String email) {
		...
		try {
            user.setPassword(AuthenticationUtils.encodeSHA256(pwd));
